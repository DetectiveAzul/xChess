...
* Just set up [AI] to true before moving a white piece. AI only plays with Black side, and its moves are triggered as soon as you execute a legal move. You can UNDO movements and train with it on three difficulty levels. 
